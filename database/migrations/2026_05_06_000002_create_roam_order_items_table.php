...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('roam_order_items', function (Blueprint $table) {
            ...
            // Parent roam_orders table သို့ ချိတ်ဆက်ထားသော Foreign Key
            ...
            $table->string('activation_code', 255)->nullable()->comment('Activation code for eSIM');
            $table->string('sm_dp_address', 255)->nullable()->comment('SM-DP+ address');
            ...
            $table->index('roam_order_id', 'roam_order_items_roam_order_id_index');
            $table->index('iccid', 'roam_order_items_iccid_index');
        });
    }
