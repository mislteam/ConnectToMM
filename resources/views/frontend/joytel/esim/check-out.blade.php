    ...
    <div class="sub-banner">
        ...
        <div class="box">
            <span class="mb-0 text-size-16">Home</span><span class="mb-0 text-size-16 dash">-</span><span
                ...
                class="mb-0 text-size-16 box_span">Checkout</span>
        </div>
    </div>
    <!--Services section-->
                ...
                <div class="col-lg-7 col-md-7 col-sm-12 col-12">
                    <div class="order-box form-design message_content">
                        ...
                        <form>
                            ...
                            <div class="form-group mb-0">
                                <label>Address</label>
                                <input type="text" class="form_style" placeholder="Enter Your Address">
                            </div>
                            <div class="row">
                                <div class="col-lg-4 col-md-4 col-sm-12 col-12">
                                    <div class="form-group mb-0">
                                        <label>City</label>
                                        <input type="text" class="form_style" placeholder="Enter Your City">
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-4 col-sm-12 col-12">
                                    <div class="form-group mb-0">
                    ...
                    <div class="order-box">
                        ...
                        <table class="table">
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <label>{{ $joytel->category_name }}</label><br>
