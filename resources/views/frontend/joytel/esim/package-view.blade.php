                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group quantity-wrapper" data-editable="1">
                                    <button class="btn btn-outline-secondary qty-minus" type="button"
                                        {{ $simType == 'recharge_esim' ? 'disabled' : '' }}>-</button>
                                    <input type="number" id="qty" name="qty"
                                        class="form-control text-center text-dark" value="1" min="1"
                                        max="100" {{ $simType != 'new_esim' ? 'readonly' : '' }}>
                            ...
                            <div class="service-box">
                                ...
                                <div class="content">
                                    ...
                                    <p class="text-size-16">
                                        ...
                                        MMK</p>
                                    <a href="{{ route('joytel.esim.packageview', ['id' => $ran_package->id, 'sim_type' => $simType ?? session('sim_type', 'new_esim')]) }}"
                                        class="more">View
                                        Offer</a>
