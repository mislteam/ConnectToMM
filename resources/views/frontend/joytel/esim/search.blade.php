        ...
        <div class="container">
            ...
            <div class="form-design tabs-container">
                <ul class="nav" role="tablist">
                    <li><a class="nav-link active" data-toggle="tab" href="#joytel-new-esim"> New eSIM</a></li>
                </ul>
                    ...
                    <div role="tabpanel" id="joytel-new-esim" class="tab-pane active">
                        <div class="panel-body">
                            <div class="message_content" data-aos="fade-up">
                                ...
                                <form method="get" action="{{ route('esim.search') }}">
                                    @csrf
                                    <div class="row">
                                        <div class="col-12">
        ...
        <div class="container">
            ...
            <div class="services-data mt-4">
                <div class="row">
                    ...
                    @empty
                        <p>Packages are temporily not available.</p>
                    @endforelse
                </div>
            </div>
