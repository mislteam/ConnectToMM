...
@section('content')
 ...
 <!-- Sub-Banner -->
        <div class="sub-banner">
            ...
            <div class="box">
                <span class="mb-0 text-size-16">Our Service</span><span class="mb-0 text-size-16 dash">-</span><span class="mb-0 text-size-16">Physical-SIM</span><span class="mb-0 text-size-16 dash">-</span><span class="mb-0 text-size-16 box_span">Roam</span>
            </div>
        </div>
        <!--Services section-->
                    ...
                    <div class="row" >
                        @forelse ($randomSkus as $package)
                            @php
                                ...
                                $itemPriceList = App\Models\PriceList::where('plan', $package->sku_id)->where('dp_status',1)->first();
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12 col-12">
                            <div class="service-box">
                                ...
                                <div class="content">
                                    ...
                                    @endif
                                    <a href="{{ route('physical.roampackageview', ['id' => $roam->sku_id]) }}" class="more">View Offer</a>
                                </div>
                            </div>
                        </div>
                         @empty
