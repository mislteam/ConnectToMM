            ...
            <div class="row services-data justify-content-center" data-aos="fade-up">
                <div class="col-lg-10 col-md-11 col-sm-12 col-12 payment-main-column">
                    <div class="order-box form-design message_content">
                        <div class="payment-status-card is-warning">
                            <div class="payment-status-header">
                                <span class="payment-status-badge">Pending Payment</span>
                            </div>
                            <div class="payment-status-title">Please complete your payment.
                            </div>
                            <p class="payment-status-message">Transfer the amount below and upload your payment slip to
                                continue with your Top Up.</p>
                        </div>

                        <div class="payment-info-row">
                            <span class="payment-info-label">Top Up Amount :</span>
                            <span class="payment-info-value">{{ number_format($transaction->amount) }} MMK</span>
                        </div>
                        ...
                        <div class="payment-summary-block">
                            <div class="payment-info-row payment-info-row-status">
                                <div class="payment-info-main">
                                    ...
                                    <span class="payment-info-value">{{ ucfirst($transaction->transaction_state) }}</span>
                                </div>
                            </div>

                            <div class="payment-info-row">
                                <span class="payment-info-label">Payment Method :</span>
                                <span class="payment-info-value">Direct Bank Transfer</span>
                            </div>
                        </div>

                        <div class="payment-section-block mb-3">
                        ...
                        <div class="form-group mb-0">
                            <label>Upload Payment Slip'<span class="required" aria-hidden="true">*</span></label>
                            <form method="POST" action="{{ route('frontend.user.topup-payment-slip', $transaction->id) }}"
                                ...
                                <div class="payment-upload-actions text-right">
                                    <button type="submit" class="button_text">Upload Slip</button>
                                </div>
                            </form>
                        </div>
                    </div>
