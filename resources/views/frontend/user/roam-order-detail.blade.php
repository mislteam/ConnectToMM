                    ...
                    <div class="order-card-body">
                        ...
                        @if (!empty($orders))
                            @foreach ($orders as $order)
                                @php
                                    $providerOrderNo = $order->roam_order_num ?? '-';
                                    $productName =
                                    ...
                                    $pendingPaymentStatus = \App\Models\RoamOrder::OUR_STATUS_PENDING_PAYMENT;
                                    $processingStatus = \App\Models\RoamOrder::OUR_STATUS_API_PROCESSING;
                                    $refundedStatus = \App\Models\RoamOrder::OUR_STATUS_REFUNDED;
                                    $adminCancelledStatus = \App\Models\RoamOrder::OUR_STATUS_ADMIN_CANCELLED;
                                @endphp
                                <div class="order-section">
                                    ...
                                    <div class="detail-grid">
                                        ...
                                        @if ((int) $order->our_status === $refundedStatus)
                                            <div class="detail-item">
