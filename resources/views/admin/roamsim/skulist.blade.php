                            ...
                            <tbody>
                                @foreach ($roamList as $index => $item)
                                    <tr>
                                        ...
                                        <td>
                                            <h5 class="text-nowrap fs-base mb-0 lh-base">{{ $item->sku_id }}</h5>
                                        </td>
                                        <td>
                                            <h5 class="text-nowrap fs-base mb-0 lh-base">{{ $item->country_name }}</h5>
                                        </td>
                                        <td>
                                            <h5 class="text-nowrap fs-base mb-0 lh-base">{{ $item->country_code }}</h5>
                                        </td>
