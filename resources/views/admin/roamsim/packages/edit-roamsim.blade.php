 ...
 <div class="container-fluid">               
                ...
                <div class="row">
                                                            ...
                                                            <table class="table table-bordered table-nowrap text-center align-middle">
                                                                ...
                                                                <tbody id="invoice-items">
                                                                    <tr>
                                                                        ...
                                                                        <td><label class="form-label fw-medium mb-0">{{$network['nameen']}}</label></td>
                                                                    </tr>
                                                                </tbody>
                                                                @endforeach
                                                            </table>
                    ...
                    <div class="col-xxl-4">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <form action="{{ route('roam.update', $roam->id) }}" 
                                    method="POST" 
                                    id="roamForm" 
                                    ...
                                    <div class="dz-message needsclick text-center">
                                        @if(!empty($roam->image))
                                            <div class="text-center mb-3">
                                                <img id="previewImage" src="{{ file_exists(public_path('storage/upload/roam/' . $roam->image)) ? asset('storage/upload/roam/' . $roam->image) : asset($roam->image ?? 'assets/images/package.jpg') }}" 
                                                    alt="Current Image" 
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="app-search">
                                                    <select name="status" class="form-select form-control my-1 my-md-0" id="statusOne" required>
                                                        ...
                                                        <option value="1" {{ $roam->roamSku->status == 1 ? 'selected' : '' }}>Enable</option>
                                                        <option value="0" {{ $roam->roamSku->status == 0 ? 'selected' : '' }}>Disable</option>
                                                    </select>
