...
@section('content')
    ...
    <style>
        .roam-update-page-title,
        .roam-update-breadcrumb-current {
            color: #111827;
        }

        .roam-update-breadcrumb-link {
            color: #4b5563;
        }

        .roam-update-breadcrumb-link:hover {
            color: #1f2937;
        }

        html[data-bs-theme="dark"] .roam-update-page-title,
        html[data-bs-theme="dark"] .roam-update-breadcrumb-current {
            color: #e5edf9;
        }

        html[data-bs-theme="dark"] .roam-update-breadcrumb-link {
            color: #9fb1cc;
        }
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div data-table data-table-rows-per-page="20" class="card">
                    <div class="card-header fw-semibold">New Esim SKU Data</div>
        ...
        <div class="row">
            <div class="col-12">
                <div data-table data-table-rows-per-page="20" class="card">
                    <div class="card-header fw-semibold">Updated Esim SKU Data</div>
                    <div class="table-responsive mb-5">
                        <table class="table table-custom table-centered table-select table-hover w-100 mb-0">
                            <thead class="bg-light align-middle bg-opacity-25 thead-sm">
                                <tr class="text-uppercase fs-xxs">
