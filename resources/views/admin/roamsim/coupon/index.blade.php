        ...
        <div class="page-title-head d-flex align-items-center">
            <div class="flex-grow-1 py-3">
                ...
                <ol class="breadcrumb m-0 py-0">
                    ...
                    <li class="breadcrumb-item active text-black">{{ $settings['roam_title']->value ?? 'Roam' }} -
                        Coupons
                    </li>
                </ol>
            </div>
                ...
                <div data-table data-table-rows-per-page="8" class="card">
                    <div class="card-header border-light justify-content-between">
                        ...
                        <div class="d-flex align-items-center gap-2">
                            ...
                            <div class="d-flex gap-1">
                                <x-create-action menu-text="Create" permission="roam.coupon.create" :url="route('roam.coupon.create')"
                                    icon="ti-plus" />
                            </div>
                        </div>
                    </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-center gap-2">
                                                <x-action-button :url="route('roam.coupon.show', $coupon->id)" permission="roam.coupon.view"
                                                    icon="ti-eye" />
                                                <x-action-button :url="route('roam.coupon.edit', $coupon->id)" permission="roam.coupon.edit"
                                                    icon="ti-edit" />

                                                <x-action-button :data-id="$coupon->id" permission="joytel.esim.delete"
                                                    icon="ti-trash" data-url="/roam/coupon/delete"
                                                    target-name="coupon-delete" class="delete-btn" />
                                            </div>
                                        </td>
                                    </tr>
                                @endforeach
                    ...
                    <div class="card-footer border-0">
                        <div class="d-flex justify-content-between align-items-center">
                            <div data-table-pagination-info="{{ $settings['roam_title']->value ?? 'Roam' }}"
