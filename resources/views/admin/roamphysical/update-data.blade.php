         ...
         <div class="row">
             <div class="col-12">
                 <div data-table data-table-rows-per-page="20" class="card">
                     <div class="card-header fw-semibold">Physical SKU Data</div>
                             ...
                             <tbody>
                                @forelse ($newSkus as $index => $sku)
                                    <tr class="table-success">
                                        ...
                                        <td>
                                            <h5 class="text-nowrap fs-base mb-0 lh-base">{{ $sku->dp_name }}</h5>
          ...
          <div class="row">
             <div class="col-12">
                 <div data-table data-table-rows-per-page="50" class="card">
                     <div class="card-header fw-semibold">Physical Pacakge Data</div>
                     <div class="table-responsive mb-5">
                         <table class="table table-custom table-centered table-select table-hover w-100 mb-0">
                             <thead class="bg-light align-middle bg-opacity-25 thead-sm">
                                 <tr class="text-uppercase fs-xxs">
                                ...
                                @forelse ($newPackages as $index => $pkg)
                                    <tr class="table-success">
                                        <td>
                                         ...
                                         <td>
                                            <h5 class="text-nowrap fs-base mb-0 lh-base">{{ $pkg['dp_name'] ?? '-' }}</h5>
