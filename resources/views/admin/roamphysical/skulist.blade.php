                                    ...
                                    <div class="card-header border-light justify-content-between">
                                        ...
                                        <div class="d-flex gap-2">
                                            <div class="app-search">
                                                <input data-table-search="global" type="search" class="form-control" placeholder="Search Country Name ...">
                                            ...
                                            <tbody>
                                                @foreach ($roamGlobal as $index => $item)
                                                    <tr>
                                                        ...
                                                        <td><h5 class="text-nowrap fs-base mb-0 lh-base">{{ $item->sku_id }}</h5></td>
                                                        <td><h5 class="text-nowrap fs-base mb-0 lh-base">{{ $item->country_name }}</h5></td>
                                                        <td><h5 class="text-nowrap fs-base mb-0 lh-base">{{ $item->country_code }}</h5></td>
                                                        <td class="{{ $item->status ? 'text-success' : 'text-danger' }} fw-semibold">
                                                            <i class="ti ti-point-filled fs-sm"></i> {{ $item->status ? 'Enable' : 'Disable' }}
                                                        </td>
                                                        <td>
                            ...
                            <div class="tab-pane fade" id="asia-tab">
                                <div data-table="asia" data-table-rows-per-page="8" >
                                    <div class="card-header border-light justify-content-between">
                                        ...
                                        <div class="d-flex gap-2">
                                            <div class="app-search">
                                                <input data-table-search="asia" type="search" class="form-control" placeholder="Search Country Name ...">
                                                <i data-lucide="search" class="app-search-icon text-muted"></i>
                                            </div>
                                        </div>
