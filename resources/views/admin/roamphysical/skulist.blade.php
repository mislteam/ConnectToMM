...
@section('content')
    <style>
        .roam-physical-sku-page-title,
        .roam-physical-sku-breadcrumb-current {
            color: #111827;
        }

        .roam-physical-sku-breadcrumb-link {
            color: #4b5563;
        }

        .roam-physical-sku-breadcrumb-link:hover {
            color: #1f2937;
        }

        html[data-bs-theme="dark"] .roam-physical-sku-page-title,
        html[data-bs-theme="dark"] .roam-physical-sku-breadcrumb-current {
            color: #e5edf9;
        }

        html[data-bs-theme="dark"] .roam-physical-sku-breadcrumb-link {
            color: #9fb1cc;
        }

        html[data-bs-theme="dark"] .roam-physical-sku-breadcrumb-link:hover {
            color: #dbe7ff;
        }
    </style>
    <div class="container-fluid">
        <div class="page-title-head d-flex align-items-center">
            <div class="flex-grow-1 py-3">
                <h4 class="fs-sm fw-bold m-0 roam-physical-sku-page-title">{{ $settings['roam_title']->value ?? 'Roam' }}</h4>
                <ol class="breadcrumb m-0 py-0">
                    <li class="breadcrumb-item"><a href="javascript: void(0);" class="roam-physical-sku-breadcrumb-link">Home</a></li>

                    <li class="breadcrumb-item active roam-physical-sku-breadcrumb-current">SKU List</li>
                </ol>
            </div>
        </div>
