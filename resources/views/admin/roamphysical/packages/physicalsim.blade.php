                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="tab-content">
                                    ...
                                    <div class="card-header border-light justify-content-between">
                                        ...
                                        <div class="d-flex gap-2">
                                            <div class="app-search">
                                                <input data-table-search="global" type="search" class="form-control" placeholder="Search Plan Name...">
                                        ...
                                        <div class="d-flex align-items-center gap-2">
                                            ...
                                            <!-- Date Range Filter -->
                                            <div class="app-search">
                                                <select data-table-range-filter="product-status" class="form-select form-control my-1 my-md-0">
                                            ...
                                            <!-- Records Per Page -->
                                            <div>
                                                <select data-table-set-rows-per-page="global" class="form-select form-control my-1 my-md-0">
                                        ...
                                        <table class="table table-custom table-centered table-select table-hover w-100 mb-0">
                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($packages->where('dp_id',9) as $pkg)
                                                        @php 
                                                            $plans=App\Models\RoamPhysical::where('sku_id',$pkg->sku_id)->first();
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><h5 class="text-nowrap fs-base mb-0 lh-base">{{ $pkg->country_name?? 'No Title' }}</h5></td>
                                                           <td class="fw-semibold {{ $status == 'Enable' ? 'text-success' : 'text-danger' }}"
                                                            ...
                                                            <td>
                                                                <div class="d-flex justify-content-center gap-1">
                                                                    <div class="btn-group">
                                                                        <button type="button" class="btn btn-light btn-icon btn-sm rounded-circle" data-bs-toggle="dropdown" aria-expanded="false"> <i class="ti ti-dots-vertical fs-lg"></i></button>
                                                                    <div class="dropdown-menu">
                                                                            <!-- Dynamic modal target using SKU ID -->
                                                                            <button type="button" class="dropdown-item" data-bs-toggle="modal" data-bs-target="#manage-price-{{ $pkg->sku_id }}">
                                                                                <i class="ti ti-currency-dollar fs-lg"></i> Manage Price
                                                                            </button>
                                                                            <button type="button" class="dropdown-item" data-bs-toggle="modal" data-bs-target="#manage-status-{{ $pkg->sku_id }}">
                                                                                <i class="ti ti-box fs-lg"></i> Manage Status
                                                                            </button>
                                                                        </div>
                                                                    </div>
                                                                    <a href="{{ route('roamPhysicalEdit', ['skuid' => $pkg['sku_id']]) }}" class="btn btn-light btn-icon btn-sm rounded-circle"><i class="ti ti-edit fs-lg"></i></a>
                            ...
                            <div class="tab-pane fade" id="asia-tab">
                                <div data-table="asia" data-table-rows-per-page="8">
                                    <div class="card-header border-light justify-content-between">
                                        ...
                                        <div class="d-flex gap-2">
                                            <div class="app-search">
                                                <input data-table-search="asia" type="search" class="form-control" placeholder="Search Plan Name...">
                                                <i data-lucide="search" class="app-search-icon text-muted"></i>
                                            </div>
                                        ...
                                        <div class="d-flex align-items-center gap-2">
                                            ...
                                            <!-- Records Per Page -->
                                            <div>
                                                <select data-table-set-rows-per-page="asia" class="form-select form-control my-1 my-md-0">
                                                    <option value="5">5</option>
                                                    <option value="10">10</option>
                                                    <option value="15">15</option>
                                                    <option value="20">20</option>
                            ...
                            <div class="modal fade" id="manage-price-{{ $pkg->sku_id }}" tabindex="-1" role="dialog" aria-labelledby="managePrice{{ $index }}" aria-hidden="true">
                                                    ...
                                                    <table class="table table-bordered table-nowrap text-center align-middle">
                                                        ...
                                                        @if(!empty($plans->packages))
                                                                ...
                                                                @php
                                                                    ...
                                                                    $savedRate = App\Models\PriceList::where('product_code', $plan['priceid'])->where('dp_status', $dpStatus)->where('dp_info', $dpInfo)->first();
                                                                    $exchange_rate = $savedRate->exchange_rate ?? 0;
                                                                    $total = number_format(round($portal_price * $exchange_rate));
                                                            
                                                                @endphp    
                                                                    <tr>
                                                                            <td>{{ $loop->iteration }}</td>
                                                                            <td class="text-start">{{ $plan['flows'] ?? '' }} {{ $plan['unit'] ?? '' }} :
                                                                            @php
                                                                                $name = $plan['showName'] ?? '';
                                                                            @endphp
                                                                            ...
                                                                            <td><label class="form-label">{{ $portal_price }}</label></td>
                                                                            <td><input type="number" class="form-control exchange-input" name="plans[{{ $innerIndex }}][exchange_rate]" value="{{ $exchange_rate }}" step="0.01"></td>
                                                                            <td><label class="form-label total-label">{{ $total }}</label></td>
                                                                            <input type="hidden" name="plans[{{ $innerIndex }}][priceid]" value="{{ $plan['priceid'] }}">
                                                                            <input type="hidden" class="portal-price" value="{{ $portal_price }}">
                                                                            <input type="hidden" name="plans[{{ $innerIndex }}][sku_id]" value="{{ $pkg->sku_id }}">
                                                                            <input type="hidden" name="plans[{{ $innerIndex }}][dp_name]" value="{{ $plan['dp_name'] ?? '' }}">
                                                                        </tr>
                                                                    @endforeach
                                                                </tbody>
                                                        @else
                            ...
                            @foreach ($packages as $index => $pkg)
                            <div class="modal fade" id="manage-status-{{ $pkg->sku_id }}" tabindex="-1" role="dialog" aria-labelledby="manageStatusLabel{{ $index }}" aria-hidden="true">
                                <div class="modal-dialog modal-lg modal-dialog-scrollable">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                                            ...
                                                            <tbody id="invoice-items">
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <form action="{{ route('roamphysical.updatePackageStatus') }}" method="POST">
                                                                            @csrf
                                                                            <input type="hidden" name="sku_id" value="{{ $pkg->sku_id }}">
                                                                            ...
                                                                            <div class="form-check form-switch form-check-secondary fs-xxl mb-2">
                                                                                ...
                                                                                <label class="form-check-label fs-base {{ ($plan['status'] ?? 0) == 1 ? 'text-success' : 'text-danger' }}">
