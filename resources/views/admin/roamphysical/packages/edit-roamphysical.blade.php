                                                        ...
                                                        @foreach ($plan['networkVos'] as $index => $network)
                                                            <tbody id="invoice-items">
                                                                <tr>
                                                                    ...
                                                                    <td><label
                                                                            class="form-label fw-medium mb-0">{{ $network['name'] }}</label>
                                                                    </td>
                                                                </tr>
                                                            </tbody>
                                                        @endforeach
            ...
            <div class="col-xxl-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-12">
                                <form action="{{ route('roamphysical.update', $roam->id) }}" method="POST" id="roamForm"
                                    ...
                                    <div class="dz-message needsclick text-center">
                                        @if (!empty($roam->image))
                                            <div class="text-center mb-3">
                                                <img id="previewImage"
                                                    src="{{ file_exists(public_path('storage/upload/roamphysical/' . $roam->image)) ? asset('storage/upload/roamphysical/' . $roam->image) : asset($roam->image ?? 'assets/images/package.jpg') }}"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="app-search">
                                                <select name="status" class="form-select form-control my-1 my-md-0"
                                                    ...
                                                    <option value="1"
                                                        {{ $roam->roamPhysicalSku->status == 1 ? 'selected' : '' }}>Enable
                                                    </option>
                                                    <option value="0"
                                                        {{ $roam->roamPhysicalSku->status == 0 ? 'selected' : '' }}>Disable
                                                    </option>
                                                </select>
