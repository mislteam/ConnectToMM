 ...
 <div class="container-fluid">               
                <div class="page-title-head d-flex align-items-center">
                    ...
                    <div class="d-flex gap-2 justify-content-end">
                        <a href="{{ route('roamphysical.Index') }}" class="btn btn-primary">Back</a>
                    </div>
                </div>
                <div class="row">
                    <div class="col-xxl-8">
                        <div class="card card-h-100 rounded-0 rounded-start">
                            <div class="card-header align-items-start px-4">
                                <h3 class="mb-1 d-flex fs-xl align-items-center fw-semibold text-black">{{ $name['country_name'] ?? 'N/A' }}</h3>
                            </div>
                                ...
                                <div class="accordion accordion-bordered" id="accordionExample">
                                        ...
                                        <div class="accordion-item border-0">
                                            <h2 class="accordion-header" id="headingOne">
                                                <button class="accordion-button shadow-none bg-light bg-opacity-50 collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse{{$index}}" aria-expanded="true" aria-controls="collapseOne">
                                                ...
                                                <div class="accordion-body">
                                                    <div class="row mb-4">
                                                        ...
                                                        <div class="col-md-4 col-xl-3">
                                                            ...
                                                            <p class="fw-medium mb-0">{{ $plan['flowType'] == '0' ? 'Available' : 'Non-Available' }}</p>
                                                        </div>
                                                        <div class="col-md-4 col-xl-3">
                                                    ...
                                                    <div class="mb-2">
                                                        ...
                                                        <div class="table-responsive mt-2">
                                                            <table class="table table-bordered table-nowrap text-center align-middle">
                                                                ...
                                                                @foreach ($plan['networkVos'] as $index => $network)
                                                                <tbody id="invoice-items">
                                                                    <tr>
                                                                        <td>1</td>
                                                                        <td class="text-start"><label class="form-label fw-medium mb-0">{{$network['type']}}</label></td>
                                                                        <td><label class="form-label fw-medium mb-0">{{$network['operator']}}</label></td>
                                                                        <td><label class="form-label fw-medium mb-0">{{$network['name']}}</label></td>
                                                                    </tr>
                                                                </tbody>
                                                                @endforeach
                                                            </table>
                    ...
                    <div class="col-xxl-4">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <form action="{{ route('roamphysical.update', $roam->id) }}" 
                                    method="POST" 
                                    id="roamForm" 
                                    ...
                                    <div class="dz-message needsclick text-center">
                                        @if(!empty($roam->image))
                                            <div class="text-center mb-3">
                                                <img id="previewImage" src="{{ file_exists(public_path('storage/upload/roamphysical/' . $roam->image)) ? asset('storage/upload/roamphysical/' . $roam->image) : asset($roam->image ?? 'assets/images/package.jpg') }}" 
                                                    alt="Current Image" 
                                                    class="img-fluid rounded" 
                                                    style="max-height: 150px;">
                                            </div>
                                        @else
                                            <img id="previewImage" src="#" alt="Preview" class="img-fluid rounded d-none mb-3" style="max-height: 150px;">
                                        @endif
                                        ...
                                        <div class="card-body">
                                            <div class="mb-3">
                                                ...
                                                <div class="app-search">
                                                    <select name="status" class="form-select form-control my-1 my-md-0" id="statusOne" required>
                                                        <option value="">Choose Status</option>
                                                        <option value="1" {{ $roam->roamPhysicalSku->status == 1 ? 'selected' : '' }}>Enable</option>
                                                        <option value="0" {{ $roam->roamPhysicalSku->status == 0 ? 'selected' : '' }}>Disable</option>
                                                    </select>
