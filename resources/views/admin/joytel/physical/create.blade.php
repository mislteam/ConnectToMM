...
@section('content')
    <div class="container-fluid">
        <div class="page-title-head d-flex align-items-center">
            <div class="flex-grow-1 py-3">
                ...
                <ol class="breadcrumb m-0 py-0">
                    ...
                    <li class="breadcrumb-item active text-black">Create Recharge Product</li>
                </ol>
            </div>
        ...
        <form action="{{ route('physical.store') }}" method="POST" enctype="multipart/form-data" id="myForm">
            @csrf
            <div class="row">
                <div class="col-xxl-8">
                    <div class="card">
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="product_type" class="form-control" id="stockNumber"
                                            placeholder="Enter Product Type(eg. Recharge)">
                                        @error('product_type')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                        ...
                        .then(async res => {
                            if (!res.ok) {
                                ...
                                try {
                                    ...
                                    msg = json.message ||
                                        text; // extract message if exists
                                } catch (e) {
                                ...
                                throw new Error(msg); // stop further processing
                            }
                            return res.json();
                        })
