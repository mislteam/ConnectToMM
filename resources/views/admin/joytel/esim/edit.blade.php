...
@section('content')
    <div class="container-fluid">
        ...
        <form action="{{ route('esim.update', $esim->id) }}" method="POST" enctype="multipart/form-data" id="myForm">
            @csrf
            @method('patch')
            <div class="row">
                <div class="col-xxl-8">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="product_name" class="form-control" id="productName"
                                            ...
                                            value="{{ old('product_name', $esim->product_name) }}">
                                        @error('product_name')
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        <label for="stockNumber" class="form-label">Supplier <span
                                                class="text-danger">*</span></label>
                                        <input type="text" name="supplier" class="form-control" id="stockNumber" readonly
                                            placeholder="Enter Suppliers" value="{{ old('supplier', $esim->supplier) }}">
                                        @error('supplier')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="product_type" class="form-control" id="stockNumber"
                                            readonly placeholder="Enter Product Type(eg. eSIM)"
                                            value="{{ old('product_type', $esim->product_type) }}">
                                        @error('product_type')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="text"
                                                                ...
                                                                value="{{ $plan['product_code'] ?? '' }}" readonly>
                                                            @error('product_code')
                                                                <small class="text-danger">{{ $message }}</small>
                                                            @enderror
                                                        </td>
                                                        ...
                                                        <td class="d-none">
                                                            ...
                                                            <input type="hidden"
                                                                ...
                                                                class="data-input" data-field="code_status"
                                                        ...
                                                        <td>
                                                            <input type="text" class="form-control data-input"
                                                                ...
                                                                name="rows[{{ $loop->iteration }}][network_type]"
                                                                value="{{ $plan['network_type'] ?? '' }}" readonly>
                                                        </td>
                                                        ...
                                                        <td>
                                                            <input type="number" class="form-control data-input"
                                                                ...
                                                                value="{{ (float) $plan['price_cny'] }}" readonly>
                                                            @error('price_cny')
                                                                <small class="text-danger">{{ $message }}</small>
                                                            @enderror
                                                        </td>
                                                        ...
                                                        <td>
                                                            <input type="date" class="form-control data-input"
                                                                ...
                                                                value="{{ $plan['expiration_date'] ?? '' }}" readonly>
                                                        ...
                                                        <td>
                                                            <input type="text" class="form-control data-input"
                                                                ...
                                                                value="{{ $plan['description'] ?? '' }}" readonly>
                                                            @error('description')
                                                                <small class="text-danger">{{ $message }}</small>
                                                            @enderror
                                                        </td>
                                ...
                                <div class="col-12">
                                    <div>
                                        ...
                                        <textarea rows="3" name="activation_policy" class="form-control mb-2"
                                            placeholder="Enter the Activation Policy">{{ old('activation_policy', $esim->activation_policy) }}</textarea>
                                ...
                                <div class="col-12">
                                    <div>
                                        ...
                                        <textarea rows="3" name="del_time" class="form-control mb-2" placeholder="Enter the Delivery Time">{{ old('del_time', $esim->delivery_time) }}</textarea>
                                        @error('del_time')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                ...
                <div class="col-xxl-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12">
                                    @if ($esim->photo !== null && is_array($esim->photo))
                                        @foreach ($esim->photo as $photo)
                                    ...
                                    <select class="select2_design form-select form-control my-1 my-md-0"
                                        ...
                                        @foreach ($usage_locations as $location)
                                            <option value="{{ $location }}"
                                                {{ in_array($location, $esim->usage_location) ? 'selected' : '' }}>
                                                {{ $location }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="app-search">
                                    <select class="form-select form-control" id="statusOne" name="status" required>
                                        <option value="1" {{ $esim->status === 1 ? 'selected' : '' }}>Enable</option>
                                        <option value="0" {{ $esim->status === 0 ? 'selected' : '' }}>Disable
                                        </option>
                                    </select>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        Dropzone.options.myAwesomeDropzone = {
            ...
            init: function() {
                ...
                // Load old photos
                @if (!empty($esim->photo) && is_array($esim->photo))
