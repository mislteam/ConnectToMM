...
@section('content')
    <style>
        .joytel-region-edit-page-title,
        .joytel-region-edit-breadcrumb-current {
            color: #111827;
        }

        .joytel-region-edit-breadcrumb-link {
            color: #4b5563;
        }

        .joytel-region-edit-breadcrumb-link:hover {
            color: #1f2937;
        }

        html[data-bs-theme="dark"] .joytel-region-edit-page-title,
        html[data-bs-theme="dark"] .joytel-region-edit-breadcrumb-current {
            color: #e5edf9;
        }

        html[data-bs-theme="dark"] .joytel-region-edit-breadcrumb-link {
            color: #9fb1cc;
        }

        html[data-bs-theme="dark"] .joytel-region-edit-breadcrumb-link:hover {
            color: #dbe7ff;
        }
    </style>
    ...
    <div class="container-fluid">
        <div class="page-title-head d-flex align-items-center">
            <div class="flex-grow-1 py-3">
                <h4 class="fs-sm fw-bold m-0 joytel-region-edit-page-title">{{ $settings['joytel_title']->value ?? 'Joytel' }}</h4>
                <ol class="breadcrumb m-0 py-0">
                    <li class="breadcrumb-item"><a href="javascript: void(0);"
                            class="joytel-region-edit-breadcrumb-link">Home</a></li>

                    <li class="breadcrumb-item active joytel-region-edit-breadcrumb-current">{{ $settings['joytel_title']->value ?? 'Joytel' }} - Edit
                        Region</li>
                </ol>
            </div>
