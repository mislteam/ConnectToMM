        ...
        <div class="page-title-head d-flex align-items-center">
            <div class="flex-grow-1 py-3">
                ...
                <ol class="breadcrumb m-0 py-0">
                    <li class="breadcrumb-item"><a href="javascript: void(0);" class="all-admin-breadcrumb-link">Home</a>
                    </li>
                                ...
                                <div data-table data-table-rows-per-page="5" class="card">
                                    <div class="card-header border-light justify-content-between">
                                        ...
                                        <div class="d-flex align-items-center gap-2">
                                            ...
                                            <!-- Role Type Filter -->
                                            <div class="app-search">
                                                <select data-table-filter="roles"
                                            ...
                                            <x-create-action menu-text="Create Admin" permission="admin.create"
                                                ...
                                                @foreach ($users as $user)
                                                    <tr>
                                                        <td class="ps-3"><input
                                                                ...
                                                                value="{{ $user->id }}"
                                                                @if ($user->role === 'administrator') disabled @endif></td>
                                                        <td>
                                                            <h5 class="m-0"><a href="#"
                                                        ...
                                                        <td>
                                                            <div class="d-flex align-items-start gap-2">
                                                                <div>
                                                                    <h5 class="fs-base mb-0"><a data-sort="user"
                                                                            href="#"
                                                        ...
                                                        <td>{{ $user->role }}</td>
                                                        <td> {{ $user->updated_at->format('d M, Y') }}<small
                                                        ...
                                                        <td>
                                                            <div class="d-flex justify-content-center gap-1">
                                                                <x-action-button :url="route('view.admin', $user->id)" permission="admin.view"
                                                                    icon="ti-eye" />
                                                                <x-action-button :url="route('admin.edit', $user->id)" permission="admin.edit"
                                                                    icon="ti-edit" />
                                                                @can('admin.delete')
                                                                    <form method="POST"
