                        ...
                        <div class="card p-4 rounded-2">
                            <div class="auth-brand text-center mb-4">
                                <a href="#" class="logo-dark">
                                    <img src="{{ asset('general/logo/'.$logo->value) }}" alt="Connect To MM" height="55px">
                                </a>
                            ...
                            <form action="{{ route('login') }}" method="POST">
                                ...
                                <div class="mb-3">
                                    <div class="input-group">
                                        <input type="email" name="email" class="form-control p-2 rounded-0" id="userEmail" placeholder="Email Address" required>
                                    </div>
                                </div>

                                <div class="mb-3">
                                    <div class="input-group">
                                        <input type="password" name="password" class="form-control p-2 rounded-0" id="userPassword" placeholder="Password" required>
                                    </div>
                                </div>

                                <div class="d-grid mb-3">
                                    <button type="submit" class="btn btn-primary fw-semibold py-2 rounded-0">Log In</button>
                                </div>
                            </form>
                        </div>
                    </div>
