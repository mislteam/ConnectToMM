    ...
    <div class="container-fluid orders-page">
        ...
        <div class="page-title-head d-flex align-items-center">
            <div class="flex-grow-1 py-3">
                <h4 class="fs-sm fw-bold m-0 orders-page-title">{{ $joytel_title->value }} Orders</h4>
                <ol class="breadcrumb m-0 py-0">
                    <li class="breadcrumb-item"><a href="javascript: void(0);" class="orders-breadcrumb-link">Home</a></li>
                    <li class="breadcrumb-item active orders-breadcrumb-current">{{ $joytel_title->value }} Orders</li>
                </ol>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <form method="GET" action="{{ route('order.joytel') }}">
                        <div class="card-header border-light justify-content-between">
                            <div class="d-flex gap-2">
                                <div class="app-search">
                                    <input name="search" type="search" class="form-control"
                                        value="{{ request('search') }}" placeholder="Search Joytel Order ID..."
                            ...
                            <tbody>
                                @forelse ($orders as $order)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('order.joytel.show', ['reference' => $order['reference']]) }}"
                                                class="order-detail-link">Detail</a>
                                        </td>
                                    </tr>
                                @empty
                                    <tr>
                                        <td colspan="6" class="text-center text-muted py-4">No Joytel orders found.
                                        </td>
                                    </tr>
                                @endforelse
                            </tbody>
                    ...
                    <div class="card-footer border-0">
                        <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
                            <div data-table-pagination-info="orders">
                                ...
                                {{ $orders->total() }} {{ $joytel_title->value }} orders
                            </div>
