                                    ...
                                    <div class="col">
                                        <div class="card rounded-0 border shadow-none border-dashed mb-0">
                                            <div class="card-body">
                                                ...
                                                <p class="text-muted mb-2 text-truncate"><span>Products sold in the
                                                        period</span>
                                                </p>
                                                <div class="progress progress-sm mb-0">
                                                    <div class="progress-bar bg-secondary" role="progressbar"
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div>
                                                    <h5 class="fs-base my-1"><a href="ecommerce-product-details.html"
                                                            class="text-body">Smart Watch</a></h5>
                                        ...
                                        <td>
                                            ...
                                            <h5 class="fs-base mt-1 fw-normal">
                                                ...
                                                <span class="ms-1"><a href="ecommerce-reviews.html"
                                                        class="link-reset fw-semibold">(45)</a></span>
                                            </h5>
                                        </td>
                                        <td>
                                            <span class="text-muted fs-xs">Status</span>
                                            <h5 class="fs-base mt-1 fw-normal"><i
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div>
                                                    <h5 class="fs-base my-1"><a href="ecommerce-product-details.html"
                                                            class="text-body">Bluetooth Speaker</a>
                                                    </h5>
                                        ...
                                        <td>
                                            ...
                                            <h5 class="fs-base mt-1 fw-normal">
                                                ...
                                                <span class="ms-1"><a href="ecommerce-reviews.html"
                                                        class="link-reset fw-semibold">(20)</a></span>
                                            </h5>
                                        </td>
                                        <td>
                                            <span class="text-muted fs-xs">Status</span>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div>
                                                    <h5 class="fs-base my-1"><a href="ecommerce-product-details.html"
                                                            class="text-body">Gaming Mouse</a></h5>
                                        ...
                                        <td>
                                            ...
                                            <h5 class="fs-base mt-1 fw-normal">
                                                ...
                                                <span class="ms-1"><a href="ecommerce-reviews.html"
                                                        class="link-reset fw-semibold">(14)</a></span>
                                            </h5>
                                        </td>
                                        <td>
                                            <span class="text-muted fs-xs">Status</span>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div>
                                                    <h5 class="fs-base my-1"><a href="ecommerce-product-details.html"
                                                            class="text-body">4K Action Camera</a>
                                                    </h5>
                                        ...
                                        <td>
                                            ...
                                            <h5 class="fs-base mt-1 fw-normal">
                                                ...
                                                <span class="ms-1"><a href="ecommerce-reviews.html"
                                                        class="link-reset fw-semibold">(31)</a></span>
                                            </h5>
                                        </td>
                                        <td>
                                            <span class="text-muted fs-xs">Status</span>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div>
                                                    <h5 class="fs-base my-1"><a href="ecommerce-product-details.html"
                                                            class="text-body">Fitness Tracker Band</a>
                                                    </h5>
                                                    <span class="text-muted fs-xs">Wearables</span>
                                                </div>
                                            </div>
                                        ...
                                        <td>
                                            ...
                                            <h5 class="fs-base mt-1 fw-normal">
                                                ...
                                                <span class="ms-1"><a href="ecommerce-reviews.html"
                                                        class="link-reset fw-semibold">(18)</a></span>
                                            </h5>
                                        </td>
                                        <td>
                                            <span class="text-muted fs-xs">Status</span>
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div>
                                                    <h5 class="fs-base my-1"><a href="ecommerce-order-details.html"
                                                            class="text-body">#ORD-1001</a></h5>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><span class="badge badge-soft-success fs-xxs"><i
                                                            class="ti ti-point-filled"></i> Paid</span></td>
                                                <td>
                                                    <img src="assets/images/cards/mastercard.svg" alt=""
                                                        class="me-2" height="28"> xxxx 1123
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td><span class="badge badge-soft-danger fs-xxs"><i
                                                            class="ti ti-point-filled"></i> Failed</span></td>
                                                <td>
                                                    <img src="assets/images/cards/visa.svg" alt="" class="me-2"
                                                        height="28"> xxxx 3490
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td><span class="badge badge-soft-success fs-xxs"><i
                                                            class="ti ti-point-filled"></i> Paid</span></td>
                                                <td>
                                                    <img src="assets/images/cards/american-express.svg" alt=""
                                                        class="me-2" height="28"> xxxx 8765
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td><span class="badge badge-soft-warning fs-xxs"><i
                                                            class="ti ti-point-filled"></i> Pending</span></td>
                                                <td>
                                                    <img src="assets/images/cards/mastercard.svg" alt=""
                                                        class="me-2" height="28"> xxxx 5566
                                                </td>
                                            </tr>
                                            <tr>
